...
function CalendarScreen() {
  ...
  const tasks = [
    { id: '1', date: '1월 6일', title: '팀퀘스트', description: 'Lorem ipsum dolor sit amet.', tag: 'very good' },
    { id: '2', date: '1월 6일', title: '리더퀘스트', description: 'Lorem ipsum dolor sit amet.', tag: 'good' },
    { id: '3', date: '1월 6일', title: '활일', description: 'Lorem ipsum dolor sit amet.', tag: 'neutral' },
  ];
        ...
        {calendar.map((week, index) => (
          <View key={index} style={styles.week}>
            {week.map((day, dayIndex) => (
              <TouchableOpacity key={dayIndex} style={styles.day} onPress={() => handleDayPress(day)}>
                <Text style={[styles.dayText, day === null && styles.emptyDay]}>{day || ''}</Text>
              </TouchableOpacity>
            ))}
          </View>
        ))}
